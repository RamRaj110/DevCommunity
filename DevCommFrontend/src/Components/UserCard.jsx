...
const UserCard = ({ user }) => {
  const { _id, firstName, lastName, photoUrl, profileImg, age, gender, about, skills } = user;


  const displayImage = profileImg || photoUrl || "https://geographyandyou.com/images/user-profile.png";
        ...
        <div className="px-6 pt-4 pb-8 text-center">
          ...
          <div className="flex justify-center gap-6">
            ...
            >
              ...
              <span className="text-xs font-medium text-slate-500 group-hover:text-red-500 transition-colors">Ignore</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-slate-500 group-hover:text-purple-400 transition-colors">Interested</span>
            </button>
